# Fixing Web Scraping in My Senior Project

_May 22, 2025_

## Background

If you don't know, my senior project is an AI resume builder. In essence, users give it an old resume or type in their experiences and education, plus a link to a job posting. Then, the app spits out a resume tailored for that specific job. It will match your experience to what the needs of the job posting, without fabricating any information. I go over it in more detail in my [previous post](/blog/senior-project-update).
