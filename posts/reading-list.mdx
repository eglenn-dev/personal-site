...
- [Choose Boring Technology](https://mcfunley.com/choose-boring-technology) by Dan McKinley
    - The idea of "innovation tokens" reframed how I evaluate my own stack choices. You only get a few, so spend them on the thing that makes your product different, not on the database. Boring tech isn't boring because it's bad, it's boring because its failure modes are already well documented by everyone who hit them first.
